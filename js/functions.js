(function(){
    ...
    let helloMessage = sayHello("Austin");
...
// and stores it in a variable named random
    ...
    let total = parseFloat(prompt('Enter the bill total'));
    console.log(`You should tip ${calculateTip(percentage, total)}`);
    ...
    let discount = parseFloat(prompt('Enter the discount percent'));
