(function() {
    ...
    shoppers.forEach(function(shopper) {
        ...
        console.log(`${shopper.name} needs to pay $${(shopper.amount > 200) ? shopper.amount - (shopper.amount * discountPercentage) : shopper.amount}`)
    });
    ...
    books.forEach(function(e,i) {
        ...
        console.log(`Author: ${e.author.firstName + " " + e.author.lastName}`);
        console.log(`---`);
    });
